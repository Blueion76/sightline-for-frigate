...
export const ICONS = {
  ...
  volOn: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3A4.5 4.5 0 0 0 14 7.97v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-8.77-7-8.77z"/></svg>',
...
export const LABEL_COLORS = { person:'#0a84ff', car:'#bf5af2', motion:'#ff9f0a', dog:'#66d4cf', cat:'#ff375f', bicycle:'#64d2ff', bird:'#ffd60a', package:'#ac8e68', face:'#5e5ce6', truck:'#30d158', bus:'#40c8e0' };

export const PALETTE = ['#0a84ff','#bf5af2','#ff9f0a','#66d4cf','#ff375f','#64d2ff','#ffd60a','#ac8e68','#5e5ce6'];

export const TIMELINE_GLYPHS = {
  ...
  // a second icon set inside the card bundle.
  person:'mdi:walk', face:'mdi:face-recognition', car:'mdi:car', vehicle:'mdi:car-multiple',
  truck:'mdi:truck', bus:'mdi:bus', bicycle:'mdi:bicycle', motorcycle:'mdi:motorbike',
  dog:'mdi:dog', cat:'mdi:cat', bird:'mdi:bird', package:'mdi:package-variant-closed',
  motion:'mdi:motion-sensor', default:'mdi:eye'
};

export const CAM_COLORS = ['rgba(10,132,255,.5)','rgba(191,90,242,.5)','rgba(48,209,88,.5)','rgba(255,159,10,.5)'];
